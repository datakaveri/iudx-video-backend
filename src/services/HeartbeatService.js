...
var HeartbeatService = /** @class */ (function () {
    function HeartbeatService(kafkaManager) {
        this.kafkaManager = kafkaManager;
    }
    HeartbeatService.prototype.statusPing = function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        message = {
                            ...
                            data: { serverId: config_1["default"].serverId, pingTime: Date.now() }
                        };
