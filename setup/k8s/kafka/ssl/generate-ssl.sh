...
TRUSTSTORE_WORKING_DIRECTORY="kafka_certs/truststore"
KEYSTORE_WORKING_DIRECTORY="kafka_certs/keystore"
CA_CERT_FILE="kafka_certs/ca-cert"
KEYSTORE_SIGN_REQUEST="kafka_certs/cert-file"
KEYSTORE_SIGN_REQUEST_SRL="kafka_certs/ca-cert.srl"
KEYSTORE_SIGNED_CERT="kafka_certs/cert-signed"
...
echo $PASS > kafka_certs/kafka_password
...
kubectl create secret generic kafka-ssl --namespace=video-server \
--from-file=kafka.truststore.jks=./kafka_certs/truststore/kafka.truststore.jks \
--from-file=kafka.keystore.jks=./kafka_certs/keystore/kafka.keystore.jks \
--from-file=kafka_password=./kafka_certs/kafka_password
