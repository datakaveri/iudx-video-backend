...
TRUSTSTORE_WORKING_DIRECTORY="$PROJECT_ROOT/kafka_certs/truststore"
KEYSTORE_WORKING_DIRECTORY="$PROJECT_ROOT/kafka_certs/keystore"
CA_CERT_FILE="$PROJECT_ROOT/kafka_certs/ca-cert"
KEYSTORE_SIGN_REQUEST="$PROJECT_ROOT/kafka_certs/cert-file"
KEYSTORE_SIGN_REQUEST_SRL="$PROJECT_ROOT/kafka_certs/ca-cert.srl"
KEYSTORE_SIGNED_CERT="$PROJECT_ROOT/kafka_certs/cert-signed"
...
rm -rf $PROJECT_ROOT/kafka_certs
mkdir $PROJECT_ROOT/kafka_certs

echo $PASS > $PROJECT_ROOT/kafka_certs/kafka_password
